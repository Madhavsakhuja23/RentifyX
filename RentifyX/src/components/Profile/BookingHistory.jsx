    ...
    return (
      <div className="profile-card" style={{ textAlign: "center", padding: "60px 32px" }}>
        ...
        <p style={{ color: "var(--text-secondary)", marginBottom: 24 }}>
          Your booking history will appear here once you reserve a property.
        </p>
        <button
        ...
        <div key={b.id} className="profile-card" style={{ padding: 0, overflow: "hidden" }}>
          <div style={{ display: "flex", gap: 0 }}>
            ...
            <div style={{ padding: "18px 22px", flex: 1, display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 10 }}>
              <div>
                <h5 style={{ fontSize: 16, fontWeight: 700, marginBottom: 4, color: "var(--text-primary)" }}>
                  {b.title}
                </h5>
                {b.location && (
              ...
              <div style={{ textAlign: "right" }}>
                <p style={{ fontSize: 18, fontWeight: 800, color: "rgb(255,102,0)", marginBottom: 8 }}>
                  {b.amount}
                </p>
                <span
                  style={{
